...
public partial class ProjetoSenaiContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) => optionsBuilder.UseSqlServer("Server=tcp:senainotasalpha.database.windows.net,1433;Initial Catalog=ProjetoSenai;Persist Security Info=False;User ID=senai;Password=S3nai@134;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30");
